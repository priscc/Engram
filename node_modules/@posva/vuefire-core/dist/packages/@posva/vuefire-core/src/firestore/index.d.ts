 ...
 * @param extraOptions
 */
export declare function bindDocument({ vm, key, document, resolve, reject, ops }: BindDocumentParamater, extraOptions?: FirestoreOptions): (reset?: FirestoreOptions['reset']) => void;

...
export default new Vuex.Store({
  state: {
    ...
    topicButtons: [
      { title: "Developments", color: "purple" },
      { title: "Summary", color: "grey lighten-3" },
  ...
  mutations: {
    ...
    topicButtonChange(state, i) {
      ...
      if (i == 0) state.topicButtons[i].color = "purple";
      else if (i == 1) state.topicButtons[i].color = "pink";
      else if (i == 2) state.topicButtons[i].color = "indigo";

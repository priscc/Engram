<template>
	<div
		class="PrivacyPolicy"
		style="height: 100%; background-color: white; height: 100%;"
	>
		<v-container>
			<h1>Privacy Policy</h1>
			<p>Last updated: June 22, 2022</p>
			<p>
			...
			<ul>
				...
				<li>
					<p>
						...
						&quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
						or &quot;Our&quot; in this Agreement) refers to Engram
						Designs, Brooklyn, NY.
					</p>
				</li>
				<li>
				...
				<li>
					<p>
						<strong>Website</strong> refers to Engram, accessible
						from
						<a
							href="engramlearn.com"
			...
			<ul>
				<li>By email: pnc2114@tc.columbia.edu</li>
			</ul>
		</v-container>
	</div>
</template>
